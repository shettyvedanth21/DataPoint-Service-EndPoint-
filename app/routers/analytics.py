...
def get_all_data(
    ...
    property_id: str | None = Query(None, description="Filter by property (e.g., current, voltage, temperature)")
):
    ...
    try:
        ...
        for table in tables:
            for record in table.records:
                # Build record with timestamp and values
                record_dict = {
                ...
                optional_fields = ["building", "location", "status", "battery_level", "raw_value", "signal_strength"]
